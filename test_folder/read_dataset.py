...
# # Above three line can solve "ModuleNotFoundError: No module named ‘common‘"
...
#     # print("dataset: ", type(dataset)) # output <class 'common.h36m_dataset.Human36mDataset'>
# else:
...
#     # print(subject) # output: S1 S5 S6 S7 S8 S9 S11
#     for action in dataset[subject].keys():
#         # print(action) # output: Smoking WalkDog ......
