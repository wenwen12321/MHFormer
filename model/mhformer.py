...
############################################################################################################## start
        ...
        ## add visibility score's version1:
        # self.trans_auto_1 = Transformer_s(4, args.frames, args.frames*2, length=3*args.n_joints, h=9)
        # self.trans_auto_2 = Transformer_s(4, args.frames, args.frames*2, length=3*args.n_joints, h=9)
        # self.trans_auto_3 = Transformer_s(4, args.frames, args.frames*2, length=3*args.n_joints, h=9)

        # self.encoder_1 = nn.Sequential(nn.Conv1d(3*args.n_joints, args.channel, kernel_size=1))
        # self.encoder_2 = nn.Sequential(nn.Conv1d(3*args.n_joints, args.channel, kernel_size=1))
        # self.encoder_3 = nn.Sequential(nn.Conv1d(3*args.n_joints, args.channel, kernel_size=1))
############################################################################################################### end
