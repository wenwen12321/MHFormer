...
class Transformer(nn.Module):
    def __init__(self, depth=6, embed_dim=512, mlp_hidden_dim=2048, h=8, drop_rate=0.1, length=27):
        super().__init__()
        drop_path_rate = 0.2
        attn_drop_rate = 0.
        qkv_bias = True
        ...
        self.Temporal_pos_embed_1 = nn.Parameter(torch.zeros(1, length, embed_dim // 3))
